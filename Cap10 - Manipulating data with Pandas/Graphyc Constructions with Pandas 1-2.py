...
#In this point we going to show a simple graphic with our dataFrame
'''
...
#In this next graphic we going to show a scater plot. It's responseble to show
#disperciosn between some varibles

dataFrame.plot.scatter(x = 'sepal length (cm)', y = 'sepal width (cm)')
plt.show()

#In this next graphic we going to show a area graphic.
